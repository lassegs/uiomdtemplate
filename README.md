...
A user can compile new outputs to output/ by running `make pdf`, `make html`, `make doc` and the likes (requiring pandoc and Latex to be installed). The text files of source/ is however meant to be human readable.
...
Contributions to the project are encouraged! There are lots of things that could improved, like:
-
-
-
