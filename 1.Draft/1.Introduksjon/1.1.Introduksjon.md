...
Blah blah [see @latourWeHaveNever2012, pp. 33-35; also @winchesterQualitativeResearchIts2016, ch. 1].

Blah blah [@latourWeHaveNever2012, pp. 33-35, 38-39 and *passim*].

Blah blah [@winchesterQualitativeResearchIts2016; @latourWeHaveNever2012].

A minus sign (-) before the @ will suppress mention of the author in the citation. This can be useful when the author is already mentioned in the text:

Smith says blah [-@winchesterQualitativeResearchIts2016].

You can also write an in-text citation, as follows:

@winchesterQualitativeResearchIts2016 says blah.

@winchesterQualitativeResearchIts2016 [p. 33] says blah.
